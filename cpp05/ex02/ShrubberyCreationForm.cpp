...
/*   Updated: 2024/02/19 16:58:21 by sycourbi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ShrubberyCreationForm::execute(Bureaucrat const &executor) const {
    ...
    // Ouvre ou crée un fichier pour écrire. La méthode c_str() convertit 
    //'fileName' de std::string à une chaîne de caractères C-style (const char*), nécessaire pour std::ofstream.
